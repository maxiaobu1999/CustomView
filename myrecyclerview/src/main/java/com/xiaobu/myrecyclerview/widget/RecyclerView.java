...
public class RecyclerView extends ViewGroup implements ScrollingView,
    ...
    /**
     * 表示控件的绘制区域是否在padding里面的，true的情况下如果你设置了padding那么绘制的区域就往里缩，
     * false则表示滑动时忽略padding的值。系统默认是true。
     * https://blog.csdn.net/liugec/article/details/76060129
     */
    ...
    /** 快速滚动 https://www.jianshu.com/p/feddf88aff67 */
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        setFocusableInTouchMode(true);//请求有触摸获取焦点的能力

        // 是系统中关于视图的各种特性的常量记录对象。其中包含各种基础数据
        ...
        //设置将不绘画吗？你重写了onDraw()当然是要进行绘画了，所以应将此语句参数置为false.
        setWillNotDraw(getOverScrollMode() == View.OVER_SCROLL_NEVER);

        mItemAnimator.setListener(mItemAnimatorListener);
        initAdapterManager();//初始化mAdapterHelper
        initChildrenHelper();//初始化mChildHelper
        initAutofill();//？
        ...
        if (attrs != null) {
            ...
            //setDescendantFocusability(int focusability) 是 ViewGroup 的方法，
            // 其作用是设置 ViewGroup 的子View获取焦点的能力。
            setDescendantFocusability(ViewGroup.FOCUS_AFTER_DESCENDANTS);
        }
...
//        Preconditions.checkNotNull(edgeEffectFactory);
    ...
    //RecyclerView 的 measure 和 layout 都是交给了 LayoutManager 去做的
    @Override
...
//              {@link LayoutManager#isAutoMeasureEnabled()} returns true.
            //下面这行应该考虑废弃，换成调用defaultOnMeasure(int, int)，但是他也改不了
...
//                        TYPE_NON_TOUCH, mReusableIntPair);
     ...
     */
    @SuppressWarnings({"SimplifiableIfStatement", "SpellCheckingInspection"})
     ...
     */
    /** 负责子VIEW的布局，核心部件 */
    @SuppressWarnings({"NullableProblems", "JavaDoc"})
     ...
     */
    @SuppressWarnings({"PointlessBitwiseExpression", "SpellCheckingInspection", "Convert2Diamond"})
...
//    }
     ...
     */
    /** Item动画 */
    @SuppressWarnings({"UnusedParameters", "NullableProblems"})
